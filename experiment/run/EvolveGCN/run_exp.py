...
def build_dataset(args):
	if args.data == 'bitcoinotc' or args.data == 'bitcoinalpha':
		...
		args.wikipedia_args == args.wikipedia_args
		return wk.Wikipedia_Dataset(args)
	elif args.data == 'reddit_jodie':
		args.reddit_args == args.reddit_args
		return wk.Reddit_Dataset(args)
	elif args.data == 'flight':
		args.flight_args == args.flight_args
		return wk.Flight_Dataset(args)
	elif args.data == 'ml25m':
		args.ml25m_args == args.ml25m_args
		return wk.ML25M_Dataset(args)
	elif args.data == 'mooc':
		args.mooc_args == args.mooc_args
		return wk.Mooc_Dataset(args)
	elif args.data == 'dgraphfin':
		args.dgraphfin_args = args.dgraphfin_args
		return wk.dgraphfin_Dataset(args)
...
if __name__ == '__main__':
	...
	torch.cuda.set_device('cuda:'+ args.cuda_device)
	try:
