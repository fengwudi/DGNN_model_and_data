...
nohup python run_exp.py --config_file ./experiments/parameters_reddit_linkpred_egcn_h.yaml > res/new/reddit_h.log &
nohup python run_exp.py --config_file ./experiments/parameters_reddit_linkpred_egcn_o.yaml > res/new/reddit_o.log &

nohup python run_exp.py --config_file ./experiments/parameters_mooc_linkpred_egcn_h.yaml > res/new/mooc_h.log &
nohup python run_exp.py --config_file ./experiments/parameters_mooc_linkpred_egcn_o.yaml > res/new/mooc_o.log &

nohup python run_exp.py --config_file ./experiments/parameters_flight_linkpred_egcn_h.yaml > res/new/flight_h.log &
nohup python run_exp.py --config_file ./experiments/parameters_flight_linkpred_egcn_o.yaml > res/new/flight_o.log &