...
class Trainer():
	...
	def run_epoch(self, split, epoch, set_name, grad):
		...
		memory_use = torch.cuda.max_memory_allocated() / 1e6

		torch.set_grad_enabled(True)
		eval_measure, epoch_AUC, epoch_AP, epoch_RECALL, epoch_ACC, epoch_F1 = self.logger.log_epoch_done()

		return eval_measure, nodes_embs, epoch_AUC, epoch_AP, epoch_RECALL, epoch_ACC, epoch_F1, epoch_time, memory_use
